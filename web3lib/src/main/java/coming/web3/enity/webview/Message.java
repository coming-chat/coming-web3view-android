...
import static coming.web3.enity.webview.Numeric.cleanHexPrefix;
...
public class Message implements Signable {
    ...
    public Message(String message, String displayOrigin, long leafPosition, SignMessageType type) {
