...
import static coming.web3.service.KeyService.FAILED_SIGNATURE;
...
import coming.web3.service.AccountKeystoreService;
import coming.web3.service.TransactionsService;
...
public class TransactionRepository implements TransactionRepositoryType {
	...
	public Single<Transaction> storeRawTx(Wallet wallet, EthTransaction rawTx, long timeStamp)
	{
		...
		return Single.fromCallable(() -> {
	      org.web3j.protocol.core.methods.response.Transaction fetchedTx = rawTx.getTransaction().get();
