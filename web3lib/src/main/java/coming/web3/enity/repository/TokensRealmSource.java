...
import static coming.web3.service.TickerService.TICKER_TIMEOUT;
import static coming.web3.service.TokensService.EXPIRED_CONTRACT;
...
import coming.web3.enity.repository.realm.RealmTokenTicker;
...
import coming.web3.service.RealmManager;
...
public class TokensRealmSource implements TokenLocalSource {
    ...
    private Token convertSingle(RealmToken realmItem, Realm realm, TokenFactory tf, Wallet wallet)
    {
        ...
        EthereumNetworkInfo  network = ethereumNetworkRepository.getNetworkByChain(info.chainId);
