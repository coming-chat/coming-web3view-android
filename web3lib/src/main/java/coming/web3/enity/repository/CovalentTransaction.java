...
public class CovalentTransaction
{
    ...
    public static EtherscanTransaction[] toEtherscanTransactions(List<CovalentTransaction> transactions, EthereumNetworkInfo  info)
    {
    ...
    private Transaction fetchRawTransaction(EthereumNetworkInfo info) throws Exception
    {
