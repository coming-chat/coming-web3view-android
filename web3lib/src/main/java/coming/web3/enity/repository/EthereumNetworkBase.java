...
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.ARBITRUM_MAIN_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.ARBITRUM_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.ARTIS_SIGMA1_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.ARTIS_TAU1_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.AVALANCHE_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.AVALANCHE_RPC_URL;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.BINANCE_MAIN_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.BINANCE_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.CLASSIC_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.CRONOS_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.FANTOM_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.FANTOM_RPC_URL;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.FANTOM_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.FANTOM_TEST_RPC_URL;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.FUJI_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.FUJI_TEST_RPC_URL;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.GOERLI_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.HECO_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.HECO_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.KOVAN_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.MAINNET_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.MATIC_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.MATIC_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.OPTIMISTIC_MAIN_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.OPTIMISTIC_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.PALM_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.PALM_TEST_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.POA_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.RINKEBY_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.ROPSTEN_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.SOKOL_ID;
import static coming.web3.enity.repository.ethereum.EthereumNetworkBase.XDAI_ID;
...
import coming.web3.token.entity.ChainSpec;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    //See the declaration of EthereumNetworkInfo - it has a member backupNodeUrl. Put your secondary node here.
    ...
    private static final LongSparseArray<EthereumNetworkInfo> networkMap = new LongSparseArray<EthereumNetworkInfo>() {
        {
            put(MAINNET_ID, new EthereumNetworkInfo(C.ETHEREUM_NETWORK_NAME, C.ETH_SYMBOL,
                    MAINNET_RPC_URL,
                    "https://cn.etherscan.com/tx/", MAINNET_ID,
                    MAINNET_FALLBACK_RPC_URL, "https://api-cn.etherscan.com/api?"));
            put(CLASSIC_ID, new EthereumNetworkInfo(C.CLASSIC_NETWORK_NAME, C.ETC_SYMBOL,
                    CLASSIC_RPC_URL,
                    "https://blockscout.com/etc/mainnet/tx/", CLASSIC_ID, CLASSIC_RPC_URL,
                    "https://blockscout.com/etc/mainnet/api?"));
            put(XDAI_ID, new EthereumNetworkInfo(C.XDAI_NETWORK_NAME, C.xDAI_SYMBOL,
                    XDAI_RPC_URL,
                    "https://blockscout.com/xdai/mainnet/tx/", XDAI_ID,
                    "https://rpc.xdaichain.com", "https://blockscout.com/xdai/mainnet/api?"));
            put(POA_ID, new EthereumNetworkInfo(C.POA_NETWORK_NAME, C.POA_SYMBOL,
                    POA_RPC_URL,
                    "https://blockscout.com/poa/core/tx/", POA_ID, POA_RPC_URL,
                    "https://blockscout.com/poa/core/api?"));
            put(ARTIS_SIGMA1_ID, new EthereumNetworkInfo(C.ARTIS_SIGMA1_NETWORK, C.ARTIS_SIGMA1_SYMBOL,
            ...
            put(MATIC_ID, new EthereumNetworkInfo(C.MATIC_NETWORK, C.MATIC_SYMBOL, MATIC_RPC_URL,
                    "https://polygonscan.com/tx/", MATIC_ID,
                    MATIC_FALLBACK_RPC_URL, "https://api.polygonscan.com/api?"));
            put(MATIC_TEST_ID, new EthereumNetworkInfo(C.MATIC_TEST_NETWORK, C.MATIC_SYMBOL,
                    MUMBAI_TEST_RPC_URL,
                    "https://mumbai.polygonscan.com/tx/", MATIC_TEST_ID,
                    MUMBAI_FALLBACK_RPC_URL, " https://api-testnet.polygonscan.com/api?"));
            put(OPTIMISTIC_MAIN_ID, new EthereumNetworkInfo(C.OPTIMISTIC_NETWORK, C.ETH_SYMBOL,
                    OPTIMISTIC_MAIN_URL,
                    "https://optimistic.etherscan.io/tx/", OPTIMISTIC_MAIN_ID, OPTIMISTIC_MAIN_FALLBACK_URL,
                    "https://api-optimistic.etherscan.io/api?"));
            put(OPTIMISTIC_TEST_ID, new EthereumNetworkInfo(C.OPTIMISTIC_TEST_NETWORK, C.ETH_SYMBOL,
                    OPTIMISTIC_TEST_URL,
            ...
            put(CRONOS_TEST_ID, new EthereumNetworkInfo(C.CRONOS_TEST_NETWORK, C.CRONOS_SYMBOL,
                    CRONOS_TEST_URL,
                    "https://cronos-explorer.crypto.org/tx/", CRONOS_TEST_ID, CRONOS_TEST_URL,
                    "https://cronos-explorer.crypto.org/api?"));
            put(ARBITRUM_MAIN_ID, new EthereumNetworkInfo(C.ARBITRUM_ONE_NETWORK, C.ARBITRUM_SYMBOL,
                    ARBITRUM_MAINNET_RPC,
                    "https://arbiscan.io/tx/", ARBITRUM_MAIN_ID, ARBITRUM_FALLBACK_MAINNET_RPC,
                    "https://api.arbiscan.io/api?"));
            put(ARBITRUM_TEST_ID, new EthereumNetworkInfo(C.ARBITRUM_TEST_NETWORK, C.ARBITRUM_TEST_SYMBOL,
                    ARBITRUM_TESTNET_RPC,
                    "https://rinkeby-explorer.arbitrum.io/tx/", ARBITRUM_TEST_ID, ARBITRUM_FALLBACK_TESTNET_RPC,
                    "")); //no transaction API
            put(PALM_ID, new EthereumNetworkInfo(C.PALM_NAME, C.PALM_SYMBOL,
                    PALM_RPC_URL,
                    "https://explorer.palm.io/tx/", PALM_ID, PALM_RPC_FALLBACK_URL,
                    "https://explorer.palm.io/api?"));
            put(PALM_TEST_ID, new EthereumNetworkInfo(C.PALM_TEST_NAME, C.PALM_SYMBOL,
                    PALM_TEST_RPC_URL,
...
//            put(PALM_TEST_ID, R.drawable.palm_logo_test);
    ...
    final EthereumNetworkInfo[] additionalNetworks;


    static class CustomNetworks {
        private ArrayList<EthereumNetworkInfo> list = new ArrayList<>();
        ...
        public void restore() {
            ...
            if (!TextUtils.isEmpty(networks)) {
                ...
                for (EthereumNetworkInfo info : list) {
        ...
        private void checkCustomNetworkSetting() {
            if (list.size() > 0 && !list.get(0).isCustom) { //need to update the list
                List<EthereumNetworkInfo> copyList = new ArrayList<>(list);
                list.clear();
                for (EthereumNetworkInfo n : copyList) {
                    EthereumNetworkInfo newInfo = new EthereumNetworkInfo(n.name, n.symbol, n.rpcServerUrl, n.etherscanUrl, n.chainId, n.backupNodeUrl, n.etherscanAPI, true);
                    list.add(newInfo);
                }
                //record back
        ...
        public void addCustomNetwork(EthereumNetworkInfo info, boolean isTestnet, Long oldChainId)
        {
            if (oldChainId != null) {
                for (EthereumNetworkInfo in : list) {
    ...
    EthereumNetworkBase(PreferenceRepositoryType preferenceRepository, EthereumNetworkInfo[] additionalNetworks, boolean useTestNets)
    {
    ...
    private void addNetworks(EthereumNetworkInfo[] networks, List<EthereumNetworkInfo> result, boolean withValue)
    {
        for (EthereumNetworkInfo network : networks)
        {
    ...
    private void addNetworks(List<EthereumNetworkInfo> result, boolean withValue)
    {
        if (withValue)
        {
        ...
        else
        {
            ...
            {
                EthereumNetworkInfo info = networkMap.valueAt(i);
    ...
    @Override
    public EthereumNetworkInfo getActiveBrowserNetwork()
    {
    ...
    @Override
    public EthereumNetworkInfo getNetworkByChain(long chainId)
    {
    ...
    @Override
    public void setActiveBrowserNetwork(EthereumNetworkInfo EthereumNetworkInfo)
    {
        if (EthereumNetworkInfo != null)
        {
            preferences.setActiveBrowserNetwork(EthereumNetworkInfo.chainId);
            for (OnNetworkChangeListener listener : onNetworkChangedListeners)
            {
                listener.onNetworkChanged(EthereumNetworkInfo);
            }
        }
        else
        {
    ...
    public EthereumNetworkInfo[] getAvailableNetworkList()
    {
        ...
        return networks.toArray(new EthereumNetworkInfo[0]);
    }

    @Override
    public EthereumNetworkInfo[] getAllActiveNetworks()
    {
        EthereumNetworkInfo[] allNetworks = getAvailableNetworkList();
        List<EthereumNetworkInfo> networks = new ArrayList<>();
    ...
    {
        EthereumNetworkInfo info = networkMap.get(networkId);
    ...
    public Token getBlankOverrideToken(EthereumNetworkInfo EthereumNetworkInfo)
    {
        return createCurrencyToken(EthereumNetworkInfo);
    }
    ...
    private static Token createCurrencyToken(EthereumNetworkInfo network)
    {
    ...
    public void addCustomRPCNetwork(String networkName, String rpcUrl, long chainId, String symbol, String blockExplorerUrl, String explorerApiUrl, boolean isTestnet, Long oldChainId) {
        EthereumNetworkInfo info = new EthereumNetworkInfo(networkName, symbol, rpcUrl, blockExplorerUrl, chainId, null, explorerApiUrl, true);
    ...
    public static EthereumNetworkInfo getEthereumNetworkInfo(long chainId) {
        return networkMap.get(chainId);
    }

    public static String getShortChainName(long chainId)
    {
        EthereumNetworkInfo info = networkMap.get(chainId);
        if (info != null)
        {
