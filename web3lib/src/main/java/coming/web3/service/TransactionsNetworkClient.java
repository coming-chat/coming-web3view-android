...
import static coming.web3.enity.repository.TokenRepository.getWeb3jService;
import static coming.web3.enity.repository.TokensRealmSource.databaseKey;
...
import coming.web3.enity.repository.ContractType;
import coming.web3.enity.repository.CovalentTransaction;
import coming.web3.enity.repository.EtherscanEvent;
import coming.web3.enity.repository.EtherscanTransaction;
import coming.web3.enity.repository.Transaction;
import coming.web3.enity.repository.TransactionMeta;
import coming.web3.enity.repository.TransactionsRealmCache;
...
import coming.web3.enity.repository.realm.RealmTransaction;
import coming.web3.enity.repository.realm.RealmTransfer;
import coming.web3.enity.repository.tokens.ERC721Token;
import coming.web3.enity.repository.tokens.Token;
import coming.web3.enity.repository.tokens.TokenInfo;
import coming.web3.enity.repository.tokenscript.EventUtils;
...
public class TransactionsNetworkClient implements TransactionsNetworkClientType
{
     ...
     */
    @Override
    public Single<Transaction[]> storeNewTransactions(String walletAddress, EthereumNetworkInfo networkInfo, String tokenAddress, final long lastBlock)
    {
     ...
     */
    private EtherscanTransaction syncDownwards(Map<String, Transaction> updates, Realm instance, String walletAddress, EthereumNetworkInfo networkInfo, String tokenAddress, long startingBlockNumber) throws Exception
    {
        int page = 1;
    ...
    private EtherscanTransaction syncUpwards(Map<String, Transaction> updates, Realm instance, String walletAddress, EthereumNetworkInfo networkInfo, String tokenAddress, long lastBlockNumber) throws Exception
    {
        int page = 1;
        List<Transaction> txList = new ArrayList<>();
    ...
    private EtherscanTransaction[] getEtherscanTransactionsFromCovalent(String response, String walletAddress, EthereumNetworkInfo info) throws JSONException
    {
        JSONObject stateData = new JSONObject(response);
    ...
    private EtherscanTransaction[] readTransactions(EthereumNetworkInfo networkInfo, String walletAddress, String tokenAddress, String firstBlock, boolean ascending, int page, int pageSize) throws JSONException
    {
     ...
     */
    @Override
    public Single<TransactionMeta[]> fetchMoreTransactions(String walletAddress, EthereumNetworkInfo network, long lastTxTime)
    {
        return Single.fromCallable(() -> {
     ...
     */
    @Override
    public Single<Integer> readTransfers(String walletAddress, EthereumNetworkInfo networkInfo, TokensService svs, boolean isNFTCheck)
    {
    ...
    private void writeTokens(String walletAddress, EthereumNetworkInfo networkInfo, EtherscanEvent[] events, TokensService svs)
    {
    ...
    private String readNextTxBatch(String walletAddress, EthereumNetworkInfo networkInfo, long currentBlock, String queryType)
    {
    ...
    private String readCovalentTransfers(String walletAddress, EthereumNetworkInfo networkInfo, long lastBlockChecked, String queryType)
    {
        //update token balances from covalent
        return ""; //Currently, covalent doesn't support fetching transfer events
    }

    private EtherscanTransaction[] readCovalentTransactions(String walletAddress, String accountAddress, EthereumNetworkInfo networkInfo, boolean ascending, int page, int pageSize) throws JSONException
    {
    ...
    private void writeEvents(Realm instance, EtherscanEvent[] events, String walletAddress,
                             @NonNull EthereumNetworkInfo networkInfo, final boolean isNFT) throws Exception
    {
    ...
    private ERC721Token createNewERC721Token(EtherscanEvent ev, EthereumNetworkInfo networkInfo, String walletAddress, boolean knownERC721)
    {
