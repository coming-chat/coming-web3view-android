...
import static coming.web3.enity.repository.TokensRealmSource.IMAGES_DB;
import static coming.web3.token.tools.TokenDefinition.TOKENSCRIPT_CURRENT_SCHEMA;
import static coming.web3.token.tools.TokenDefinition.TOKENSCRIPT_REPO_SERVER;
...
import coming.web3.enity.repository.ContractLocator;
import coming.web3.enity.repository.ContractType;
import coming.web3.enity.repository.FragmentMessenger;
import coming.web3.enity.repository.TokenLocalSource;
import coming.web3.enity.repository.TokenLocator;
import coming.web3.enity.repository.TokensRealmSource;
import coming.web3.enity.repository.Transaction;
import coming.web3.enity.repository.TransactionRepositoryType;
...
import coming.web3.enity.repository.realm.RealmCertificateData;
import coming.web3.enity.repository.realm.RealmTokenScriptData;
import coming.web3.enity.repository.tokens.ERC721Token;
import coming.web3.enity.repository.tokens.Token;
import coming.web3.enity.repository.tokens.TokenFactory;
import coming.web3.enity.repository.tokenscript.EventUtils;
import coming.web3.enity.repository.tokenscript.TokenScriptFile;
import coming.web3.enity.repository.tokenscript.TokenscriptFunction;
import coming.web3.token.entity.Attribute;
import coming.web3.token.entity.AttributeInterface;
import coming.web3.token.entity.ContractAddress;
import coming.web3.token.entity.ContractInfo;
import coming.web3.token.entity.EvaluateSelection;
import coming.web3.token.entity.EventDefinition;
import coming.web3.token.entity.FunctionDefinition;
import coming.web3.token.entity.MethodArg;
import coming.web3.token.entity.ParseResult;
import coming.web3.token.entity.SigReturnType;
import coming.web3.token.entity.TSAction;
import coming.web3.token.entity.TSSelection;
import coming.web3.token.entity.TokenScriptResult;
import coming.web3.token.entity.TokenscriptContext;
import coming.web3.token.entity.TokenscriptElement;
import coming.web3.token.entity.TransactionResult;
import coming.web3.token.entity.XMLDsigDescriptor;
    ...
    private String processLogs(EventDefinition ev, List<EthLog.LogResult> logs, String walletAddress)
    {
        ...
        for (int i = index; i >= 0; i--)
        {
            ...
            else
            {
                ...
                Transaction tx = transactionRepository.fetchCachedTransaction(walletAddress, txHash);
